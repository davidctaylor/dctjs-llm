...
const COMPONENT_MAP: Record<PageBuilderComponentType, any> = {
  [PageBuilderComponentType.PAGE_CONTAINER]: lazy(() =>
  ...
  [PageBuilderComponentType.PAGE_SECTION]: lazy(() =>
    import('../../components/section-container/section-container').then(
      ({ SectionContainer }) => ({
        default: SectionContainer,
      })
  ...
  [PageBuilderComponentType.CARD]: lazy(() =>
  ...
  [PageBuilderComponentType.CAROUSEL]: lazy(() =>
